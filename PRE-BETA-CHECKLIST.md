...
### 4.19 Confirm print_run = 1 on all Superfractor rows — ✅ DONE
...
- **Why deferred:** Beta scope is the five formats Blaster, Mega, Hobby, Jumbo, Breaker Delight (display order, left to right — least to greatest by price and odds). Retail-only legacy boxes (1995–2017) won't appear in beta. Cleanest beta scope, fully modern-relevant, no premature cost on Retail-specific data entry templates or pull-rate sourcing for boxes that may not even ship in beta.
